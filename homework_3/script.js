...
const firstCar = new Car("Ololo", "model 1", "red", "hatch", 4, "gas", "robot", 2500);
const secondCar = new ServiceCar("Lololo", "model 2", "blue", "lift", 6, "diesel", "robot", 2700);
const thirdCar = new TruckCar("Ololo", "model 3", "green", "hatch", 6, "gas", "robot", 2500);
const fourthCar = new Car("Ololo", "model 4", "yellow", "hatch", 3, "diesel", "robot", 2400);
